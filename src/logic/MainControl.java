...
public class MainControl {
	...
	public static void createWorld() {
		 ...
		 * world = new World(4,3);
		 * 
		 * world.setTile(0,0,new Floor(Signalcolor.blue,Cabletype.so));
		 * world.setTile(0,2,new Floor(Signalcolor.blue,Cabletype.no));
		 * world.setTile(1,0,new Floor(Signalcolor.blue,Cabletype.osw));
		 * world.setTile(3,2,new Floor(Signalcolor.blue,Cabletype.nw));
		 * world.setTile(2,0,new Floor(Signalcolor.blue,Cabletype.m));
		 * world.setTile(3,0,new Floor(Signalcolor.blue,Cabletype.w));
		 * world.setTile(2,1,new Floor(Signalcolor.blue,Cabletype.sn));
		 * world.setTile(2,2,new Floor(Signalcolor.blue,Cabletype.wno));
		 * world.setTile(3,1,new Floor(Signalcolor.blue,Cabletype.s));
		 * world.setTile(1,1,new Floor(Signalcolor.blue,Cabletype.nws));
		 * world.setTile(1,2,new Floor(Signalcolor.blue,Cabletype.wno));
...
/**
 * world.setTile(0,0,new
 * Förderband(Rotation.right,2,Signalcolor.red,Cabletype.notype));
 * world.setTile(1,0,new
 * Förderband(Rotation.right,2,Signalcolor.red,Cabletype.notype));
 * world.setTile(2,0,new
 * Förderband(Rotation.down,2,Signalcolor.blue,Cabletype.notype));
 * world.setTile(2,1,new
 * Förderband(Rotation.down,2,Signalcolor.blue,Cabletype.notype));
 * world.setTile(2,2,new
 * Förderband(Rotation.right,2,Signalcolor.blue,Cabletype.notype));
 * world.setTile(1,2,new
 * Förderband(Rotation.left,2,Signalcolor.blue,Cabletype.notype));
 * world.setTile(0,2,new
 * Förderband(Rotation.up,2,Signalcolor.red,Cabletype.notype));
 * world.setTile(0,1,new
 * Förderband(Rotation.up,2,Signalcolor.red,Cabletype.notype));
 * 
 ...
 * 
 * world.addEntity(new Box(0,0)); world.addEntity(new Box(2,0));
 * world.addEntity(new Box(2,2)); world.addEntity(new Box(0,2));
 */
